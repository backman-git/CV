...
\setlength{\textheight}{9.5in} % increase text height to fit on 1-page 
	...
	\begin{document} 
		...
		\moveleft.5\hoffset\centerline{\href{https://www.linkedin.com/in/chung-yi-kao-60161ba4/}{https://www.linkedin.com/in/chung-yi-kao-60161ba4/}}
		...
		\begin{resume}
 			...
 			\section{OBJECTIVE \& SUMMARY}
				...
				Software Engineer with experience in Mobile Application, backend system developing, Android system stack, including system service developing, UI animation, a Simulation application, and auxiliary tools.
 			
			\vspace{-0.1in}
			\section{TECHNICAL SKILLS}          
				\begin{itemize}
					\item {\bf Program Language}: Python, Java, JavaScript, C++ ,swift 3
					\vspace{-0.05in}
					\item {\bf Framework}:iOS, Android Stack \& SDK, Node.js, MongoDB, Jade, Less.js
					\vspace{-0.05in}
