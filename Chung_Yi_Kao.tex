...
\setlength{\textheight}{9.5in} % increase text height to fit on 1-page 
	...
	\begin{document} 
		...
		\begin{resume}
 			...
 			\section{SUMMARY}
 				%Amdroid version
 				Software Engineer with experience in Android Application and Android system stack, including system service developing, VR application, UI animation, Simulation application, auxiliary tools. 
